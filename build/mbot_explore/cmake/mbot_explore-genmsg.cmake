...
set(MSG_I_FLAGS "-Imbot_explore:/home/wyy/META/COURSE/hybrid_control/hybrid_control_match/src/mbot_explore/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/wyy/META/COURSE/hybrid_control/hybrid_control_match/src/mbot_explore/msg/PointArray.msg" NAME_WE)
add_custom_target(_mbot_explore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mbot_explore" "/home/wyy/META/COURSE/hybrid_control/hybrid_control_match/src/mbot_explore/msg/PointArray.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(mbot_explore
  "/home/wyy/META/COURSE/hybrid_control/hybrid_control_match/src/mbot_explore/msg/PointArray.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mbot_explore)
  install(CODE "execute_process(COMMAND \"/home/wyy/META/COURSE/hybrid_control/hybrid_control_match/hybrid_control/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mbot_explore\")")
  # install generated code
  install(
